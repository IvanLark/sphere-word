...
export default function Accordion({ title, child, titleClass = "bg-teal-500 text-white", childClass = "bg-gray-100" }: { title: string, child: JSX.Element, titleClass: string, childClass: string }) {
