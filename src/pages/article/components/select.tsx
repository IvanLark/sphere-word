...
export default function Select({ label, options, onChange, className, width = 400, labelWidth = 100 }: SelectProps) {
	...
	return (
		<div className="relative">
			<div className={`h-14 relative rounded-md  border-2 border-black text-xl overflow-hidden transition-all duration-300 ${selectWinOpen ? 'rounded-tl-none' : 'rounded-l-none'} ${className}`} style={{ width: width - labelWidth, height: selectWinOpen ? `${Object.keys(options).length * 3.5 + 3.5}rem` : '3.5rem', marginLeft: labelWidth }} >
